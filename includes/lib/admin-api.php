...
class Mass_Messaging_in_BuddyPress_Admin_API
{
	...
	public function display_field($data = [], $post = false, $echo = true) {
		...
		switch ($field[ 'type' ]) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __('Upload an image', 'mass-messaging-in-buddypress') . '" data-uploader_button_text="' . __('Use image', 'mass-messaging-in-buddypress') . '" class="image_upload_button button" value="' . __('Upload new image', 'mass-messaging-in-buddypress') . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __('Remove image', 'mass-messaging-in-buddypress') . '" />' . "\n";
